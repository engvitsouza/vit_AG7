...
if 1
    ...
    sd_i_norm = read_signal(fn_signal_norm_values_real);
    sd_q_norm = read_signal(fn_signal_norm_values_imag);
    
 %alerta de gambi vit souza
   sd_i_norm_quant_rx = reshape(  sd_i_norm,Ns,[]);
   sd_q_norm_quant_rx = reshape(  sd_q_norm,Ns,[]);
end
